...
startdate: 2026-05-22      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2026-05-23        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Claire Zwiers Cook"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
google_form: https://forms.gle/sghMnLVU6BEJGAsUA
...
<p id="registration">
  ...
  Please register for the workshop using
    <a href="{{ page.google_form }}" target="_blank">this Google Form</a>.
    <br><br>
  {% endif %}
</p>
